 ...
 * <ul>
 *   <li>{@link caex.impl.VersionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link caex.impl.VersionImpl#getChangeMode <em>Change Mode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VersionImpl extends MinimalEObjectImpl.Container implements Version {
	...
	public void setChangeMode(ChangeMode newChangeMode) {
		...
		changeModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaexPackage.VERSION__CHANGE_MODE, oldChangeMode, changeMode, !oldChangeModeESet));
	}
	...
	public void unsetChangeMode() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CaexPackage.VERSION__CHANGE_MODE, oldChangeMode, CHANGE_MODE_EDEFAULT, oldChangeModeESet));
	}
