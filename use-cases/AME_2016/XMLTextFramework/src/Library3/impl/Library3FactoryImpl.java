...
public class Library3FactoryImpl extends EFactoryImpl implements Library3Factory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case Library3Package.ANY_GENERIC_ELEMENT: return createAnyGenericElement();
			case Library3Package.ANY_GENERIC_ATTRIBUTE: return createAnyGenericAttribute();
			case Library3Package.ANY_GENERIC_TEXT: return createAnyGenericText();
			default:
