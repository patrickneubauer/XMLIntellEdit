...
public class ToscabasetypesAdapterFactory extends AdapterFactoryImpl {
	...
	protected ToscabasetypesSwitch<Adapter> modelSwitch =
		new ToscabasetypesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTServerProperties(TServerProperties object) {
				return createTServerPropertiesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link toscabasetypes.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link toscabasetypes.TServerProperties <em>TServer Properties</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTServerPropertiesAdapter() {
		return null;
	}
