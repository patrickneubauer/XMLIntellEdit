...
public class SerializerTestMoodleTypes {
	...
	private static final String INPUT_MODEL = "models/Moodle-by-Iaas/Definitions/modified/MoodleTypes-Definitions-modified.xml"; // must end with .xml
