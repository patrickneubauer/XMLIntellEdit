...
public class SerializerTestToscaSpecificTypes {
	...
	private static final String INPUT_MODEL = "models/Moodle-by-Iaas/Definitions/modified/TOSCA-v1.0-SpecificTypes-Definitions-modified.xml"; // must end with .xml
