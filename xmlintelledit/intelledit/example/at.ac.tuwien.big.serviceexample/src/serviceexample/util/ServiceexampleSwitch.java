 ...
 * @generated
 */
public class ServiceexampleSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ServiceexamplePackage modelPackage;
	 ...
	 * @generated
	 */
	public ServiceexampleSwitch() {
		if (modelPackage == null) {
			modelPackage = ServiceexamplePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ServiceexamplePackage.CLUSTER: {
				...
				if (result == null) result = caseNamedThing(cluster);
			...
			case ServiceexamplePackage.SERVICE: {
				...
				if (result == null) result = caseNamedThing(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServiceexamplePackage.SERVER: {
				...
				if (result == null) result = caseNamedThing(server);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
