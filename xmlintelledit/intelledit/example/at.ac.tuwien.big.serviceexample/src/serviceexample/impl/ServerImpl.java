 ...
 * </p>
 * <ul>
 *   <li>{@link serviceexample.impl.ServerImpl#getSpeed <em>Speed</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServerImpl extends NamedThingImpl implements Server {
	/**
	...
	protected EClass eStaticClass() {
		return ServiceexamplePackage.Literals.SERVER;
	}
	...
	public void setSpeed(BigInteger newSpeed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServiceexamplePackage.SERVER__SPEED, oldSpeed, speed));
	}
