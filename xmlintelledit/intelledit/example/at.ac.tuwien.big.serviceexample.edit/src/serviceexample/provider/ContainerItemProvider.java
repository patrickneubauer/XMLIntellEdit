...
/**
 * This is the item provider adapter for a {@link serviceexample.Container} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContainerItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ServiceexamplePackage.Literals.CONTAINER__SERVICE);
			childrenFeatures.add(ServiceexamplePackage.Literals.CONTAINER__CLUSTER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ServiceexamplePackage.Literals.CONTAINER__SERVICE,
				 ServiceexampleFactory.eINSTANCE.createService()));

		newChildDescriptors.add
			(createChildParameter
				(ServiceexamplePackage.Literals.CONTAINER__CLUSTER,
				 ServiceexampleFactory.eINSTANCE.createCluster()));
	}
