...
/**
 * This is the item provider adapter for a {@link serviceexample.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider extends NamedThingItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServiceexamplePackage.Literals.SERVICE__PROVIDED_BY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDesignSpeedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_designSpeed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_designSpeed_feature", "_UI_Service_type"),
				 ServiceexamplePackage.Literals.SERVICE__DESIGN_SPEED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ServiceexamplePackage.Literals.SERVICE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
