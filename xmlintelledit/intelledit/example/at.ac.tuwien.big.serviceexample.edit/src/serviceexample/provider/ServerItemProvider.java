...
/**
 * This is the item provider adapter for a {@link serviceexample.Server} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerItemProvider extends NamedThingItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Server_speed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Server_speed_feature", "_UI_Server_type"),
				 ServiceexamplePackage.Literals.SERVER__SPEED,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Server.class)) {
			case ServiceexamplePackage.SERVER__SPEED:
