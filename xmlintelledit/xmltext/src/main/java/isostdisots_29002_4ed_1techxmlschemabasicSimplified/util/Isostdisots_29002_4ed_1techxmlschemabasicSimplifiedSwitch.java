 ...
 * @generated
 */
public class Isostdisots_29002_4ed_1techxmlschemabasicSimplifiedSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public Isostdisots_29002_4ed_1techxmlschemabasicSimplifiedSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Isostdisots_29002_4ed_1techxmlschemabasicSimplifiedPackage.INTERNATIONAL_TEXT: {
				InternationalText internationalText = (InternationalText)theEObject;
				T result = caseInternationalText(internationalText);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>International Text</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>International Text</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInternationalText(InternationalText object) {
		return null;
	}
...
} //Isostdisots_29002_4ed_1techxmlschemabasicSimplifiedSwitch
