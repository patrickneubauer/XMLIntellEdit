 ...
 * </p>
 * <ul>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getStringValues <em>String Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getBagValues <em>Bag Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getBooleanValues <em>Boolean Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getComplexValues <em>Complex Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getCompositeValues <em>Composite Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getControlledValues <em>Controlled Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getCurrencyValues <em>Currency Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getDateValues <em>Date Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getDateTimeValues <em>Date Time Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getFileValues <em>File Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getIntegerValues <em>Integer Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getItemReferenceValues <em>Item Reference Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getLocalizedTextValues <em>Localized Text Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getMeasureQualifiedNumberValues <em>Measure Qualified Number Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getMeasureRangeValues <em>Measure Range Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getMeasureSingleNumberValues <em>Measure Single Number Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getNullValues <em>Null Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getRationalValues <em>Rational Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getRealValues <em>Real Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getSequenceValues <em>Sequence Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getSetValues <em>Set Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getTimeValues <em>Time Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getYearMonthValues <em>Year Month Values</em>}</li>
 *   <li>{@link isostdisots_29002_10ed_1techxmlschemavalueSimplified.impl.SequenceValueImpl#getYearValues <em>Year Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SequenceValueImpl extends MinimalEObjectImpl.Container implements SequenceValue {
	/**
	...
	protected EClass eStaticClass() {
		return Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.Literals.SEQUENCE_VALUE;
	}
	...
	public EList<StringValue> getStringValues() {
		if (stringValues == null) {
			stringValues = new EObjectContainmentEList<StringValue>(StringValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__STRING_VALUES);
		}
		return stringValues;
	}
	...
	public EList<BagValue> getBagValues() {
		if (bagValues == null) {
			bagValues = new EObjectContainmentEList<BagValue>(BagValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__BAG_VALUES);
		}
		return bagValues;
	}
	...
	public EList<BooleanValue> getBooleanValues() {
		if (booleanValues == null) {
			booleanValues = new EObjectContainmentEList<BooleanValue>(BooleanValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__BOOLEAN_VALUES);
		}
	...
	public EList<ComplexValue> getComplexValues() {
		if (complexValues == null) {
			complexValues = new EObjectContainmentEList<ComplexValue>(ComplexValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__COMPLEX_VALUES);
		}
	...
	public EList<CompositeValue> getCompositeValues() {
		if (compositeValues == null) {
			compositeValues = new EObjectContainmentEList<CompositeValue>(CompositeValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__COMPOSITE_VALUES);
		}
	...
	public EList<ControlledValue> getControlledValues() {
		if (controlledValues == null) {
			controlledValues = new EObjectContainmentEList<ControlledValue>(ControlledValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__CONTROLLED_VALUES);
		}
	...
	public EList<CurrencyValue> getCurrencyValues() {
		if (currencyValues == null) {
			currencyValues = new EObjectContainmentEList<CurrencyValue>(CurrencyValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__CURRENCY_VALUES);
		}
	...
	public EList<DateValue> getDateValues() {
		if (dateValues == null) {
			dateValues = new EObjectContainmentEList<DateValue>(DateValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__DATE_VALUES);
		}
		return dateValues;
	}
	...
	public EList<DateTimeValue> getDateTimeValues() {
		if (dateTimeValues == null) {
			dateTimeValues = new EObjectContainmentEList<DateTimeValue>(DateTimeValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__DATE_TIME_VALUES);
		}
	...
	public EList<FileValue> getFileValues() {
		if (fileValues == null) {
			fileValues = new EObjectContainmentEList<FileValue>(FileValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__FILE_VALUES);
		}
		return fileValues;
	}
	...
	public EList<IntegerValue> getIntegerValues() {
		if (integerValues == null) {
			integerValues = new EObjectContainmentEList<IntegerValue>(IntegerValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__INTEGER_VALUES);
		}
	...
	public EList<ItemReferenceValue> getItemReferenceValues() {
		if (itemReferenceValues == null) {
			itemReferenceValues = new EObjectContainmentEList<ItemReferenceValue>(ItemReferenceValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__ITEM_REFERENCE_VALUES);
		}
	...
	public EList<LocalizedTextValue> getLocalizedTextValues() {
		if (localizedTextValues == null) {
			localizedTextValues = new EObjectContainmentEList<LocalizedTextValue>(LocalizedTextValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__LOCALIZED_TEXT_VALUES);
		}
	...
	public EList<MeasureQualifiedNumberValue> getMeasureQualifiedNumberValues() {
		if (measureQualifiedNumberValues == null) {
			measureQualifiedNumberValues = new EObjectContainmentEList<MeasureQualifiedNumberValue>(MeasureQualifiedNumberValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_QUALIFIED_NUMBER_VALUES);
		}
	...
	public EList<MeasureRangeValue> getMeasureRangeValues() {
		if (measureRangeValues == null) {
			measureRangeValues = new EObjectContainmentEList<MeasureRangeValue>(MeasureRangeValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_RANGE_VALUES);
		}
	...
	public EList<MeasureSingleNumberValue> getMeasureSingleNumberValues() {
		if (measureSingleNumberValues == null) {
			measureSingleNumberValues = new EObjectContainmentEList<MeasureSingleNumberValue>(MeasureSingleNumberValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_SINGLE_NUMBER_VALUES);
		}
	...
	public EList<NullValue> getNullValues() {
		if (nullValues == null) {
			nullValues = new EObjectContainmentEList<NullValue>(NullValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__NULL_VALUES);
		}
		return nullValues;
	}
	...
	public EList<RationalValue> getRationalValues() {
		if (rationalValues == null) {
			rationalValues = new EObjectContainmentEList<RationalValue>(RationalValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__RATIONAL_VALUES);
		}
	...
	public EList<RealValue> getRealValues() {
		if (realValues == null) {
			realValues = new EObjectContainmentEList<RealValue>(RealValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__REAL_VALUES);
		}
		return realValues;
	}
	...
	public EList<SequenceValue> getSequenceValues() {
		if (sequenceValues == null) {
			sequenceValues = new EObjectContainmentEList<SequenceValue>(SequenceValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__SEQUENCE_VALUES);
		}
	...
	public EList<SetValue> getSetValues() {
		if (setValues == null) {
			setValues = new EObjectContainmentEList<SetValue>(SetValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__SET_VALUES);
		}
		return setValues;
	}
	...
	public EList<TimeValue> getTimeValues() {
		if (timeValues == null) {
			timeValues = new EObjectContainmentEList<TimeValue>(TimeValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__TIME_VALUES);
		}
		return timeValues;
	}
	...
	public EList<YearMonthValue> getYearMonthValues() {
		if (yearMonthValues == null) {
			yearMonthValues = new EObjectContainmentEList<YearMonthValue>(YearMonthValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__YEAR_MONTH_VALUES);
		}
	...
	public EList<YearValue> getYearValues() {
		if (yearValues == null) {
			yearValues = new EObjectContainmentEList<YearValue>(YearValue.class, this, Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__YEAR_VALUES);
		}
		return yearValues;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__STRING_VALUES:
				return ((InternalEList<?>)getStringValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__BAG_VALUES:
				return ((InternalEList<?>)getBagValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__BOOLEAN_VALUES:
				return ((InternalEList<?>)getBooleanValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__COMPLEX_VALUES:
				return ((InternalEList<?>)getComplexValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__COMPOSITE_VALUES:
				return ((InternalEList<?>)getCompositeValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__CONTROLLED_VALUES:
				return ((InternalEList<?>)getControlledValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__CURRENCY_VALUES:
				return ((InternalEList<?>)getCurrencyValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__DATE_VALUES:
				return ((InternalEList<?>)getDateValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__DATE_TIME_VALUES:
				return ((InternalEList<?>)getDateTimeValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__FILE_VALUES:
				return ((InternalEList<?>)getFileValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__INTEGER_VALUES:
				return ((InternalEList<?>)getIntegerValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__ITEM_REFERENCE_VALUES:
				return ((InternalEList<?>)getItemReferenceValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__LOCALIZED_TEXT_VALUES:
				return ((InternalEList<?>)getLocalizedTextValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_QUALIFIED_NUMBER_VALUES:
				return ((InternalEList<?>)getMeasureQualifiedNumberValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_RANGE_VALUES:
				return ((InternalEList<?>)getMeasureRangeValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__MEASURE_SINGLE_NUMBER_VALUES:
				return ((InternalEList<?>)getMeasureSingleNumberValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__NULL_VALUES:
				return ((InternalEList<?>)getNullValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__RATIONAL_VALUES:
				return ((InternalEList<?>)getRationalValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__REAL_VALUES:
				return ((InternalEList<?>)getRealValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__SEQUENCE_VALUES:
				return ((InternalEList<?>)getSequenceValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__SET_VALUES:
				return ((InternalEList<?>)getSetValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__TIME_VALUES:
				return ((InternalEList<?>)getTimeValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__YEAR_MONTH_VALUES:
				return ((InternalEList<?>)getYearMonthValues()).basicRemove(otherEnd, msgs);
			case Isostdisots_29002_10ed_1techxmlschemavalueSimplifiedPackage.SEQUENCE_VALUE__YEAR_VALUES:
