 ...
 * </p>
 * <ul>
 *   <li>{@link isostdisois_13584_32ed_1techxmlschemaontomlSimplified.impl.LANGUAGEImpl#getCountryCode <em>Country Code</em>}</li>
 *   <li>{@link isostdisois_13584_32ed_1techxmlschemaontomlSimplified.impl.LANGUAGEImpl#getLanguageCode <em>Language Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LANGUAGEImpl extends MinimalEObjectImpl.Container implements LANGUAGE {
	...
	protected EClass eStaticClass() {
		return Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.Literals.LANGUAGE;
	}
	...
	public void setCountryCode(String newCountryCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.LANGUAGE__COUNTRY_CODE, oldCountryCode, countryCode));
	}
	...
	public void setLanguageCode(String newLanguageCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.LANGUAGE__LANGUAGE_CODE, oldLanguageCode, languageCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.LANGUAGE__COUNTRY_CODE:
				return getCountryCode();
			case Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.LANGUAGE__LANGUAGE_CODE:
