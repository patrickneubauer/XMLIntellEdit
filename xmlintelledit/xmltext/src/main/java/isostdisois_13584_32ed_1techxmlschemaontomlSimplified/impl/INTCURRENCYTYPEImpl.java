...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>INTCURRENCYTYPE</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link isostdisois_13584_32ed_1techxmlschemaontomlSimplified.impl.INTCURRENCYTYPEImpl#getValueFormat <em>Value Format</em>}</li>
 *   <li>{@link isostdisois_13584_32ed_1techxmlschemaontomlSimplified.impl.INTCURRENCYTYPEImpl#getCurrency <em>Currency</em>}</li>
 *   <li>{@link isostdisois_13584_32ed_1techxmlschemaontomlSimplified.impl.INTCURRENCYTYPEImpl#getCurrencyId <em>Currency Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class INTCURRENCYTYPEImpl extends ANYTYPEImpl implements INTCURRENCYTYPE {
	/**
	...
	protected EClass eStaticClass() {
		return Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.Literals.INTCURRENCYTYPE;
	}
	...
	public void setValueFormat(String newValueFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__VALUE_FORMAT, oldValueFormat, valueFormat));
	}
	...
	public void setCurrency(String newCurrency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__CURRENCY, oldCurrency, currency));
	}
	...
	public void setCurrencyId(String newCurrencyId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__CURRENCY_ID, oldCurrencyId, currencyId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__VALUE_FORMAT:
				return getValueFormat();
			case Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__CURRENCY:
				return getCurrency();
			case Isostdisois_13584_32ed_1techxmlschemaontomlSimplifiedPackage.INTCURRENCYTYPE__CURRENCY_ID:
