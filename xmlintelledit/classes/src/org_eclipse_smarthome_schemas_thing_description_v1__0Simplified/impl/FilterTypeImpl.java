 ...
 * </p>
 * <ul>
 *   <li>{@link org_eclipse_smarthome_schemas_thing_description_v1__0Simplified.impl.FilterTypeImpl#getCriterias <em>Criterias</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilterTypeImpl extends MinimalEObjectImpl.Container implements FilterType {
	 ...
	 * @ordered
	 */
	protected EList<CriteriaType> criterias;
	...
	protected EClass eStaticClass() {
		return org_eclipse_smarthome_schemas_thing_description_v1__0SimplifiedPackage.Literals.FILTER_TYPE;
	}
	 ...
	 * @generated
	 */
	public EList<CriteriaType> getCriterias() {
		if (criterias == null) {
			criterias = new EObjectContainmentEList<CriteriaType>(CriteriaType.class, this, org_eclipse_smarthome_schemas_thing_description_v1__0SimplifiedPackage.FILTER_TYPE__CRITERIAS);
		}
		return criterias;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case org_eclipse_smarthome_schemas_thing_description_v1__0SimplifiedPackage.FILTER_TYPE__CRITERIAS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case org_eclipse_smarthome_schemas_thing_description_v1__0SimplifiedPackage.FILTER_TYPE__CRITERIAS:
				getCriterias().clear();
				getCriterias().addAll((Collection<? extends CriteriaType>)newValue);
				return;
		}
