 ...
 * @generated
 */
public class org_eclipse_smarthome_schemas_config_description_v1__0SimplifiedSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public org_eclipse_smarthome_schemas_config_description_v1__0SimplifiedSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case org_eclipse_smarthome_schemas_config_description_v1__0SimplifiedPackage.CONFIG_DESCRIPTIONS: {
				ConfigDescriptions configDescriptions = (ConfigDescriptions)theEObject;
				T result = caseConfigDescriptions(configDescriptions);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Config Descriptions</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Config Descriptions</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConfigDescriptions(ConfigDescriptions object) {
		return null;
	}
...
} //org_eclipse_smarthome_schemas_config_description_v1__0SimplifiedSwitch
