...
/**
 * This is the item provider adapter for a {@link library3Simplified.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(library3SimplifiedPackage.Literals.LIBRARY__BOOKS);
			childrenFeatures.add(library3SimplifiedPackage.Literals.LIBRARY__CUSTOMERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(library3SimplifiedPackage.Literals.LIBRARY__BOOKS,
				 library3SimplifiedFactory.eINSTANCE.createBook()));

		newChildDescriptors.add
			(createChildParameter
				(library3SimplifiedPackage.Literals.LIBRARY__CUSTOMERS,
				 library3SimplifiedFactory.eINSTANCE.createCustomer()));
	}
