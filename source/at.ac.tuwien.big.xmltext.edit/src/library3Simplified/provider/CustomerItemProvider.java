...
/**
 * This is the item provider adapter for a {@link library3Simplified.Customer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CustomerItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBorrowedBookIdPropertyDescriptor(object);
			addBorrowedBookSincePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 library3SimplifiedPackage.Literals.CUSTOMER__FIRST_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 library3SimplifiedPackage.Literals.CUSTOMER__LAST_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Borrowed Book Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBorrowedBookIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_borrowedBookId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_borrowedBookId_feature", "_UI_Customer_type"),
				 library3SimplifiedPackage.Literals.CUSTOMER__BORROWED_BOOK_ID,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Borrowed Book Since feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBorrowedBookSincePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Customer_borrowedBookSince_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Customer_borrowedBookSince_feature", "_UI_Customer_type"),
				 library3SimplifiedPackage.Literals.CUSTOMER__BORROWED_BOOK_SINCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
