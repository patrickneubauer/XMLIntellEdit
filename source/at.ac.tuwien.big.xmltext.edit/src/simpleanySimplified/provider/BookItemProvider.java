/**
 */
package simpleanySimplified.provider;
...
/**
 * This is the item provider adapter for a {@link simpleanySimplified.Book} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BookItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 simpleanySimplifiedPackage.Literals.BOOK__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 simpleanySimplifiedPackage.Literals.BOOK__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 simpleanySimplifiedPackage.Literals.BOOK__AUTHOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(simpleanySimplifiedPackage.Literals.BOOK__DESCRIPTION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Book.class)) {
			case simpleanySimplifiedPackage.BOOK__NAME:
			case simpleanySimplifiedPackage.BOOK__TITLE:
			case simpleanySimplifiedPackage.BOOK__AUTHOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case simpleanySimplifiedPackage.BOOK__DESCRIPTION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(simpleanySimplifiedPackage.Literals.BOOK__DESCRIPTION,
				 simpleanySimplifiedFactory.eINSTANCE.createDescription()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return simpleanySimplifiedEditPlugin.INSTANCE;
	}
