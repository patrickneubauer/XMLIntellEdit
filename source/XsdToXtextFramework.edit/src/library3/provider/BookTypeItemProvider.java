...
/**
 * This is the item provider adapter for a {@link library3.BookType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BookTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BookType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BookType_name_feature", "_UI_BookType_type"),
				 Library3Package.Literals.BOOK_TYPE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Library3Package.Literals.BOOK_TYPE__TITLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Library3Package.Literals.BOOK_TYPE__AUTHOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPagesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BookType_pages_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BookType_pages_feature", "_UI_BookType_type"),
				 Library3Package.Literals.BOOK_TYPE__PAGES,
				 true,
				 false,
				 false,
	...
	protected void addIsbnPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BookType_isbn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BookType_isbn_feature", "_UI_BookType_type"),
				 Library3Package.Literals.BOOK_TYPE__ISBN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Library3Package.Literals.BOOK_TYPE__BOOK_INFO);
		}
	...
	public String getText(Object object) {
		String label = ((BookType)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Library3Package.Literals.BOOK_TYPE__BOOK_INFO,
				 Library3Factory.eINSTANCE.createBookInfoType()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return Library3baseEditPlugin.INSTANCE;
	}
