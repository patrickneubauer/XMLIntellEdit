 ...
 * <ul>
 *   <li>{@link com.example.example.references.untyped.OrdersType#getOrder1 <em>Order1</em>}</li>
 *   <li>{@link com.example.example.references.untyped.OrdersType#getOrder2 <em>Order2</em>}</li>
 *   <li>{@link com.example.example.references.untyped.OrdersType#getOrderReference1 <em>Order Reference1</em>}</li>
 *   <li>{@link com.example.example.references.untyped.OrdersType#getOrderReference2 <em>Order Reference2</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.example.references.untyped.UntypedPackage#getOrdersType()
...
public interface OrdersType extends EObject {
	 ...
	 * The list contents are of type {@link com.example.example.references.untyped.OrderDetail1}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.untyped.UntypedPackage#getOrdersType_Order1()
	 ...
	 * The list contents are of type {@link com.example.example.references.untyped.OrderDetail2}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.untyped.UntypedPackage#getOrdersType_Order2()
	 * @model containment="true" required="true"
	 ...
	 * The list contents are of type {@link com.example.example.references.untyped.OrderRef1}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.untyped.UntypedPackage#getOrdersType_OrderReference1()
	 * @model containment="true" required="true"
	 ...
	 * The list contents are of type {@link com.example.example.references.untyped.OrderRef2}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.untyped.UntypedPackage#getOrdersType_OrderReference2()
	 * @model containment="true" required="true"
