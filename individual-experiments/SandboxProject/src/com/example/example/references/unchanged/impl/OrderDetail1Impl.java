...
import com.example.example.references.unchanged.OrderDetail1;
 ...
 * <ul>
 *   <li>{@link com.example.example.references.unchanged.impl.OrderDetail1Impl#getCustomerAddress <em>Customer Address</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrderDetail1Impl#getCustomerContact <em>Customer Contact</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrderDetail1Impl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrderDetail1Impl#getOrderID <em>Order ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderDetail1Impl extends MinimalEObjectImpl.Container implements OrderDetail1 {
	...
	protected EClass eStaticClass() {
		return UnchangedPackage.Literals.ORDER_DETAIL1;
	}
	...
	public void setCustomerAddress(String newCustomerAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ORDER_DETAIL1__CUSTOMER_ADDRESS, oldCustomerAddress, customerAddress));
	}
	...
	public void setCustomerContact(String newCustomerContact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ORDER_DETAIL1__CUSTOMER_CONTACT, oldCustomerContact, customerContact));
	}
	...
	public void setCustomerName(String newCustomerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ORDER_DETAIL1__CUSTOMER_NAME, oldCustomerName, customerName));
	}
	...
	public void setOrderID(String newOrderID) {
		...
		orderID = newOrderID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ORDER_DETAIL1__ORDER_ID, oldOrderID, orderID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnchangedPackage.ORDER_DETAIL1__CUSTOMER_ADDRESS:
				return getCustomerAddress();
			case UnchangedPackage.ORDER_DETAIL1__CUSTOMER_CONTACT:
				return getCustomerContact();
			case UnchangedPackage.ORDER_DETAIL1__CUSTOMER_NAME:
				return getCustomerName();
			case UnchangedPackage.ORDER_DETAIL1__ORDER_ID:
				return getOrderID();
		}
