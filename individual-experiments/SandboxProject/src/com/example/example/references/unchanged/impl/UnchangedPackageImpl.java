...
import com.example.example.references.unchanged.UnchangedFactory;
...
public class UnchangedPackageImpl extends EPackageImpl implements UnchangedPackage {
	 ...
	 * @see com.example.example.references.unchanged.UnchangedPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getOrderRef1_OrderDetail1() {
		return (EAttribute)orderRef1EClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(orderRef1EClass, ORDER_REF1__ORDER_DETAIL1);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOrderRef1_OrderDetail1(), theXMLTypePackage.getIDREF(), "orderDetail1", null, 0, 1, OrderRef1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
