...
import com.example.example.references.unchanged.OrderRef2;
 ...
 * <ul>
 *   <li>{@link com.example.example.references.unchanged.impl.OrdersTypeImpl#getOrder1 <em>Order1</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrdersTypeImpl#getOrder2 <em>Order2</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrdersTypeImpl#getOrderReference1 <em>Order Reference1</em>}</li>
 *   <li>{@link com.example.example.references.unchanged.impl.OrdersTypeImpl#getOrderReference2 <em>Order Reference2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrdersTypeImpl extends MinimalEObjectImpl.Container implements OrdersType {
	...
	protected EClass eStaticClass() {
		return UnchangedPackage.Literals.ORDERS_TYPE;
	}
	...
	public EList<OrderDetail1> getOrder1() {
		if (order1 == null) {
			order1 = new EObjectContainmentEList<OrderDetail1>(OrderDetail1.class, this, UnchangedPackage.ORDERS_TYPE__ORDER1);
		}
		return order1;
	}
	...
	public EList<OrderDetail2> getOrder2() {
		if (order2 == null) {
			order2 = new EObjectContainmentEList<OrderDetail2>(OrderDetail2.class, this, UnchangedPackage.ORDERS_TYPE__ORDER2);
		}
		return order2;
	}
	...
	public EList<OrderRef1> getOrderReference1() {
		if (orderReference1 == null) {
			orderReference1 = new EObjectContainmentEList<OrderRef1>(OrderRef1.class, this, UnchangedPackage.ORDERS_TYPE__ORDER_REFERENCE1);
		}
	...
	public EList<OrderRef2> getOrderReference2() {
		if (orderReference2 == null) {
			orderReference2 = new EObjectContainmentEList<OrderRef2>(OrderRef2.class, this, UnchangedPackage.ORDERS_TYPE__ORDER_REFERENCE2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UnchangedPackage.ORDERS_TYPE__ORDER1:
				return ((InternalEList<?>)getOrder1()).basicRemove(otherEnd, msgs);
			case UnchangedPackage.ORDERS_TYPE__ORDER2:
				return ((InternalEList<?>)getOrder2()).basicRemove(otherEnd, msgs);
			case UnchangedPackage.ORDERS_TYPE__ORDER_REFERENCE1:
				return ((InternalEList<?>)getOrderReference1()).basicRemove(otherEnd, msgs);
			case UnchangedPackage.ORDERS_TYPE__ORDER_REFERENCE2:
