 ...
 * <ul>
 *   <li>{@link com.example.example.references.OrderDetail1#getCustomerAddress <em>Customer Address</em>}</li>
 *   <li>{@link com.example.example.references.OrderDetail1#getCustomerContact <em>Customer Contact</em>}</li>
 *   <li>{@link com.example.example.references.OrderDetail1#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.references.OrderDetail1#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.example.references.ReferencesPackage#getOrderDetail1()
...
public interface OrderDetail1 extends EObject {
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrderDetail1_CustomerAddress()
	...
	/**
	 * Sets the value of the '{@link com.example.example.references.OrderDetail1#getCustomerAddress <em>Customer Address</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrderDetail1_CustomerContact()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link com.example.example.references.OrderDetail1#getCustomerContact <em>Customer Contact</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrderDetail1_CustomerName()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link com.example.example.references.OrderDetail1#getCustomerName <em>Customer Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see com.example.example.references.ReferencesPackage#getOrderDetail1_Name()
	...
	/**
	 * Sets the value of the '{@link com.example.example.references.OrderDetail1#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
