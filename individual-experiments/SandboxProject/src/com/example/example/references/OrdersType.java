 ...
 * <ul>
 *   <li>{@link com.example.example.references.OrdersType#getOrder1 <em>Order1</em>}</li>
 *   <li>{@link com.example.example.references.OrdersType#getOrder2 <em>Order2</em>}</li>
 *   <li>{@link com.example.example.references.OrdersType#getOrderReference1 <em>Order Reference1</em>}</li>
 *   <li>{@link com.example.example.references.OrdersType#getOrderReference2 <em>Order Reference2</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.example.references.ReferencesPackage#getOrdersType()
...
public interface OrdersType extends EObject {
	 ...
	 * The list contents are of type {@link com.example.example.references.OrderDetail1}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrdersType_Order1()
	 ...
	 * The list contents are of type {@link com.example.example.references.OrderDetail2}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrdersType_Order2()
	 * @model containment="true" required="true"
	 ...
	 * The list contents are of type {@link com.example.example.references.OrderRef1}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrdersType_OrderReference1()
	 * @model containment="true" required="true"
	 ...
	 * The list contents are of type {@link com.example.example.references.OrderRef2}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see com.example.example.references.ReferencesPackage#getOrdersType_OrderReference2()
	 * @model containment="true" required="true"
