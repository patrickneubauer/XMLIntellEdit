 ...
 * <ul>
 *   <li>{@link com.example.example.references.impl.OrderDetail1Impl#getCustomerAddress <em>Customer Address</em>}</li>
 *   <li>{@link com.example.example.references.impl.OrderDetail1Impl#getCustomerContact <em>Customer Contact</em>}</li>
 *   <li>{@link com.example.example.references.impl.OrderDetail1Impl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.references.impl.OrderDetail1Impl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderDetail1Impl extends MinimalEObjectImpl.Container implements OrderDetail1 {
	...
	protected EClass eStaticClass() {
		return ReferencesPackage.Literals.ORDER_DETAIL1;
	}
	...
	public void setCustomerAddress(String newCustomerAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.ORDER_DETAIL1__CUSTOMER_ADDRESS, oldCustomerAddress, customerAddress));
	}
	...
	public void setCustomerContact(String newCustomerContact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.ORDER_DETAIL1__CUSTOMER_CONTACT, oldCustomerContact, customerContact));
	}
	...
	public void setCustomerName(String newCustomerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.ORDER_DETAIL1__CUSTOMER_NAME, oldCustomerName, customerName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.ORDER_DETAIL1__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReferencesPackage.ORDER_DETAIL1__CUSTOMER_ADDRESS:
				return getCustomerAddress();
			case ReferencesPackage.ORDER_DETAIL1__CUSTOMER_CONTACT:
				return getCustomerContact();
			case ReferencesPackage.ORDER_DETAIL1__CUSTOMER_NAME:
				return getCustomerName();
			case ReferencesPackage.ORDER_DETAIL1__NAME:
				return getName();
		}
