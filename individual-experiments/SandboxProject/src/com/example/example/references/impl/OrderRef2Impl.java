 ...
 * <ul>
 *   <li>{@link com.example.example.references.impl.OrderRef2Impl#getOrderDetail2 <em>Order Detail2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderRef2Impl extends MinimalEObjectImpl.Container implements OrderRef2 {
	...
	protected EClass eStaticClass() {
		return ReferencesPackage.Literals.ORDER_REF2;
	}
	...
	public void setOrderDetail2(OrderDetail2 newOrderDetail2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesPackage.ORDER_REF2__ORDER_DETAIL2, oldOrderDetail2, orderDetail2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReferencesPackage.ORDER_REF2__ORDER_DETAIL2:
