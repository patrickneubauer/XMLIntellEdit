...
public class ReferencesFactoryImpl extends EFactoryImpl implements ReferencesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ReferencesPackage.DOCUMENT_ROOT: return createDocumentRoot();
			case ReferencesPackage.ORDER_DETAIL1: return createOrderDetail1();
			case ReferencesPackage.ORDER_DETAIL2: return createOrderDetail2();
			case ReferencesPackage.ORDER_REF1: return createOrderRef1();
			case ReferencesPackage.ORDER_REF2: return createOrderRef2();
			case ReferencesPackage.ORDERS_TYPE: return createOrdersType();
			default:
