 ...
 * <ul>
 *   <li>{@link com.example.example.referencesuntyped.impl.OrderDetail2Impl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.referencesuntyped.impl.OrderDetail2Impl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderDetail2Impl extends MinimalEObjectImpl.Container implements OrderDetail2 {
	...
	protected EClass eStaticClass() {
		return ReferencesuntypedPackage.Literals.ORDER_DETAIL2;
	}
	...
	public void setCustomerName(String newCustomerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesuntypedPackage.ORDER_DETAIL2__CUSTOMER_NAME, oldCustomerName, customerName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesuntypedPackage.ORDER_DETAIL2__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReferencesuntypedPackage.ORDER_DETAIL2__CUSTOMER_NAME:
				return getCustomerName();
			case ReferencesuntypedPackage.ORDER_DETAIL2__NAME:
				return getName();
		}
