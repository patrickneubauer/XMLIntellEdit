...
import com.example.example.referencesuntypedimports.DocumentRoot;
...
import com.example.example.referencesuntypedimports.ReferencesuntypedimportsFactory;
 ...
 * @generated
 */
public class ReferencesuntypedimportsPackageImpl extends EPackageImpl implements ReferencesuntypedimportsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.example.example.referencesuntypedimports.ReferencesuntypedimportsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ReferencesuntypedimportsPackageImpl() {
		super(eNS_URI, ReferencesuntypedimportsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ReferencesuntypedimportsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ReferencesuntypedimportsPackage init() {
		if (isInited) return (ReferencesuntypedimportsPackage)EPackage.Registry.INSTANCE.getEPackage(ReferencesuntypedimportsPackage.eNS_URI);

		// Obtain or create and register package
		ReferencesuntypedimportsPackageImpl theReferencesuntypedimportsPackage = (ReferencesuntypedimportsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ReferencesuntypedimportsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ReferencesuntypedimportsPackageImpl());
		...
		theReferencesuntypedimportsPackage.createPackageContents();

		// Initialize created meta-data
		theReferencesuntypedimportsPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theReferencesuntypedimportsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ReferencesuntypedimportsPackage.eNS_URI, theReferencesuntypedimportsPackage);
		return theReferencesuntypedimportsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOrdersType_ImportURI() {
	 ...
	 * @generated
	 */
	public ReferencesuntypedimportsFactory getReferencesuntypedimportsFactory() {
		return (ReferencesuntypedimportsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(ordersTypeEClass, ORDERS_TYPE__IMPORT_URI);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOrdersType_ImportURI(), theXMLTypePackage.getString(), "importURI", null, 1, 1, OrdersType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
...
} //ReferencesuntypedimportsPackageImpl
