 ...
 * <ul>
 *   <li>{@link com.example.example.referencesuntypedimports.impl.OrderDetail2Impl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.referencesuntypedimports.impl.OrderDetail2Impl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderDetail2Impl extends MinimalEObjectImpl.Container implements OrderDetail2 {
	...
	protected EClass eStaticClass() {
		return ReferencesuntypedimportsPackage.Literals.ORDER_DETAIL2;
	}
	...
	public void setCustomerName(String newCustomerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesuntypedimportsPackage.ORDER_DETAIL2__CUSTOMER_NAME, oldCustomerName, customerName));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferencesuntypedimportsPackage.ORDER_DETAIL2__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ReferencesuntypedimportsPackage.ORDER_DETAIL2__CUSTOMER_NAME:
				return getCustomerName();
			case ReferencesuntypedimportsPackage.ORDER_DETAIL2__NAME:
				return getName();
		}
