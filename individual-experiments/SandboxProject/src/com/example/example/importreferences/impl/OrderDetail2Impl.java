 ...
 * <ul>
 *   <li>{@link com.example.example.importreferences.impl.OrderDetail2Impl#getCustomerName <em>Customer Name</em>}</li>
 *   <li>{@link com.example.example.importreferences.impl.OrderDetail2Impl#getOrderID <em>Order ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrderDetail2Impl extends MinimalEObjectImpl.Container implements OrderDetail2 {
	...
	protected EClass eStaticClass() {
		return ImportreferencesPackage.Literals.ORDER_DETAIL2;
	}
	...
	public void setCustomerName(String newCustomerName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImportreferencesPackage.ORDER_DETAIL2__CUSTOMER_NAME, oldCustomerName, customerName));
	}
	...
	public void setOrderID(String newOrderID) {
		...
		orderID = newOrderID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImportreferencesPackage.ORDER_DETAIL2__ORDER_ID, oldOrderID, orderID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImportreferencesPackage.ORDER_DETAIL2__CUSTOMER_NAME:
				return getCustomerName();
			case ImportreferencesPackage.ORDER_DETAIL2__ORDER_ID:
				return getOrderID();
		}
