...
import com.example.example.importreferences.ImportreferencesFactory;
 ...
 * @generated
 */
public class ImportreferencesPackageImpl extends EPackageImpl implements ImportreferencesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.example.example.importreferences.ImportreferencesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ImportreferencesPackageImpl() {
		super(eNS_URI, ImportreferencesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ImportreferencesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ImportreferencesPackage init() {
		if (isInited) return (ImportreferencesPackage)EPackage.Registry.INSTANCE.getEPackage(ImportreferencesPackage.eNS_URI);

		// Obtain or create and register package
		ImportreferencesPackageImpl theImportreferencesPackage = (ImportreferencesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ImportreferencesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ImportreferencesPackageImpl());
		...
		theImportreferencesPackage.createPackageContents();

		// Initialize created meta-data
		theImportreferencesPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theImportreferencesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ImportreferencesPackage.eNS_URI, theImportreferencesPackage);
		return theImportreferencesPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOrdersType_ImportedNamespace() {
		return (EAttribute)ordersTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public ImportreferencesFactory getImportreferencesFactory() {
		return (ImportreferencesFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(ordersTypeEClass, ORDERS_TYPE__IMPORTED_NAMESPACE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getOrderRef1_OrderDetail1(), this.getOrderDetail1(), null, "orderDetail1", null, 0, 1, OrderRef1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(orderRef2EClass, OrderRef2.class, "OrderRef2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOrderRef2_OrderDetail2(), this.getOrderDetail2(), null, "orderDetail2", null, 0, 1, OrderRef2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOrdersType_ImportedNamespace(), ecorePackage.getEString(), "importedNamespace", null, 0, 1, OrdersType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
