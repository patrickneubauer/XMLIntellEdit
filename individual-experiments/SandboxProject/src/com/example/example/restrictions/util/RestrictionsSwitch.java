...
public class RestrictionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RestrictionsPackage.RESTRICTED_ADDRESS: {
				RestrictedAddress restrictedAddress = (RestrictedAddress)theEObject;
				T result = caseRestrictedAddress(restrictedAddress);
				if (result == null) result = caseAddress(restrictedAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Restricted Address</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Restricted Address</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRestrictedAddress(RestrictedAddress object) {
		return null;
	}
