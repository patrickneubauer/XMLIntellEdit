...
public class RestrictionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected RestrictionsSwitch<Adapter> modelSwitch =
		new RestrictionsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRestrictedAddress(RestrictedAddress object) {
				return createRestrictedAddressAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.example.restrictions.Address <em>Address</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.example.restrictions.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.example.restrictions.OrderDetail <em>Order Detail</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.example.restrictions.OrdersType <em>Orders Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.example.example.restrictions.RestrictedAddress <em>Restricted Address</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRestrictedAddressAdapter() {
		return null;
	}
