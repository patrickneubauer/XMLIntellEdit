 ...
 * <ul>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element3Impl#getRepeatableElement1 <em>Repeatable Element1</em>}</li>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element3Impl#getRepeatableElement2 <em>Repeatable Element2</em>}</li>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element3Impl#getRepeatableElement3 <em>Repeatable Element3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Element3Impl extends MinimalEObjectImpl.Container implements Element3 {
	...
	protected EClass eStaticClass() {
		return UnchangedPackage.Literals.ELEMENT3;
	}
	...
	public EList<String> getRepeatableElement1() {
		if (repeatableElement1 == null) {
			repeatableElement1 = new EDataTypeEList<String>(String.class, this, UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT1);
		}
	...
	public void setRepeatableElement2(String newRepeatableElement2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT2, oldRepeatableElement2, repeatableElement2));
	}
	...
	public void setRepeatableElement3(String newRepeatableElement3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT3, oldRepeatableElement3, repeatableElement3));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT1:
				return getRepeatableElement1();
			case UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT2:
				return getRepeatableElement2();
			case UnchangedPackage.ELEMENT3__REPEATABLE_ELEMENT3:
