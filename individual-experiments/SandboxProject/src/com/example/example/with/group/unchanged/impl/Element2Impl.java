 ...
 * <ul>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element2Impl#getModelGroupElement1 <em>Model Group Element1</em>}</li>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element2Impl#getModelGroupElement2 <em>Model Group Element2</em>}</li>
 *   <li>{@link com.example.example.with.group.unchanged.impl.Element2Impl#getModelGroupElement3 <em>Model Group Element3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class Element2Impl extends MinimalEObjectImpl.Container implements Element2 {
	...
	protected EClass eStaticClass() {
		return UnchangedPackage.Literals.ELEMENT2;
	}
	...
	public EList<String> getModelGroupElement1() {
		if (modelGroupElement1 == null) {
			modelGroupElement1 = new EDataTypeEList<String>(String.class, this, UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT1);
		}
	...
	public void setModelGroupElement2(String newModelGroupElement2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT2, oldModelGroupElement2, modelGroupElement2));
	}
	...
	public void setModelGroupElement3(String newModelGroupElement3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT3, oldModelGroupElement3, modelGroupElement3));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT1:
				return getModelGroupElement1();
			case UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT2:
				return getModelGroupElement2();
			case UnchangedPackage.ELEMENT2__MODEL_GROUP_ELEMENT3:
