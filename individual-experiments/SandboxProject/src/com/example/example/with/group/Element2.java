 ...
 * <ul>
 *   <li>{@link com.example.example.with.group.Element2#getModelGroupElement1 <em>Model Group Element1</em>}</li>
 *   <li>{@link com.example.example.with.group.Element2#getModelGroupElement2 <em>Model Group Element2</em>}</li>
 *   <li>{@link com.example.example.with.group.Element2#getModelGroupElement3 <em>Model Group Element3</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.example.with.group.GroupPackage#getElement2()
...
public interface Element2 extends EObject {
	 ...
	 * @see com.example.example.with.group.GroupPackage#getElement2_ModelGroupElement1()
	 ...
	 * @see com.example.example.with.group.GroupPackage#getElement2_ModelGroupElement2()
	...
	/**
	 * Sets the value of the '{@link com.example.example.with.group.Element2#getModelGroupElement2 <em>Model Group Element2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.with.group.GroupPackage#getElement2_ModelGroupElement3()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String" required="true"
	...
	/**
	 * Sets the value of the '{@link com.example.example.with.group.Element2#getModelGroupElement3 <em>Model Group Element3</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
