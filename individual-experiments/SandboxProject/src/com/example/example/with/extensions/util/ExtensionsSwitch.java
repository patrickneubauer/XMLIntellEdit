...
public class ExtensionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExtensionsPackage.DOCUMENT_ROOT: {
			...
			case ExtensionsPackage.EXTENDED_ADDRESS: {
				ExtendedAddress extendedAddress = (ExtendedAddress)theEObject;
				T result = caseExtendedAddress(extendedAddress);
				if (result == null) result = caseAddress(extendedAddress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extended Address</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extended Address</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtendedAddress(ExtendedAddress object) {
		return null;
	}
