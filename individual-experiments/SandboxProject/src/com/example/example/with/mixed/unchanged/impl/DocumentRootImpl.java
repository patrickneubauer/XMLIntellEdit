 ...
 * <ul>
 *   <li>{@link com.example.example.with.mixed.unchanged.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.example.example.with.mixed.unchanged.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.example.example.with.mixed.unchanged.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.example.example.with.mixed.unchanged.impl.DocumentRootImpl#getRootElement <em>Root Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public RootElementType getRootElement() {
		return (RootElementType)getMixed().get(UnchangedPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, true);
	}
	...
	public NotificationChain basicSetRootElement(RootElementType newRootElement, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(UnchangedPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, newRootElement, msgs);
	}
	...
	public void setRootElement(RootElementType newRootElement) {
		((FeatureMap.Internal)getMixed()).set(UnchangedPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, newRootElement);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case UnchangedPackage.DOCUMENT_ROOT__ROOT_ELEMENT:
