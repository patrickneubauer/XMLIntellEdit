 ...
 * @generated
 */
public class MixedSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MixedPackage.MODEL_TYPE: {
				ModelType modelType = (ModelType)theEObject;
				T result = caseModelType(modelType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MixedPackage.MY_ELEMENT: {
				MyElement myElement = (MyElement)theEObject;
				T result = caseMyElement(myElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MixedPackage.PAIR: {
				Pair pair = (Pair)theEObject;
				T result = casePair(pair);
				if (result == null) result = caseMyElement(pair);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MixedPackage.PAIRS: {
				Pairs pairs = (Pairs)theEObject;
				T result = casePairs(pairs);
				if (result == null) result = caseMyElement(pairs);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pairs</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pairs</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePairs(Pairs object) {
		return null;
	}
