 ...
 * <ul>
 *   <li>{@link com.example.example.with.mixed.impl.ModelTypeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelTypeImpl extends MinimalEObjectImpl.Container implements ModelType {
	...
	protected EClass eStaticClass() {
		return MixedPackage.Literals.MODEL_TYPE;
	}
	...
	public EList<MyElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<MyElement>(MyElement.class, this, MixedPackage.MODEL_TYPE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MixedPackage.MODEL_TYPE__ELEMENTS:
