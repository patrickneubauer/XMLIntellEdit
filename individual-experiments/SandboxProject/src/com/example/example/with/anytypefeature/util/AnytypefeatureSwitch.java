 ...
 * @generated
 */
public class AnytypefeatureSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnytypefeaturePackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnytypefeaturePackage.ELEMENT1: {
				Element1 element1 = (Element1)theEObject;
				T result = caseElement1(element1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnytypefeaturePackage.PROPERTIES: {
				Properties properties = (Properties)theEObject;
				T result = caseProperties(properties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnytypefeaturePackage.ROOT_ELEMENT_TYPE: {
