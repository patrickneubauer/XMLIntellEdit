...
import com.example.example.with.anytypefeature.AnytypefeatureFactory;
import com.example.example.with.anytypefeature.AnytypefeaturePackage;
import com.example.example.with.anytypefeature.DocumentRoot;
import com.example.example.with.anytypefeature.Element1;
import com.example.example.with.anytypefeature.Properties;
import com.example.example.with.anytypefeature.RootElementType;
 ...
 * @generated
 */
public class AnytypefeaturePackageImpl extends EPackageImpl implements AnytypefeaturePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.example.example.with.anytypefeature.AnytypefeaturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AnytypefeaturePackageImpl() {
		super(eNS_URI, AnytypefeatureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AnytypefeaturePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AnytypefeaturePackage init() {
		if (isInited) return (AnytypefeaturePackage)EPackage.Registry.INSTANCE.getEPackage(AnytypefeaturePackage.eNS_URI);

		// Obtain or create and register package
		AnytypefeaturePackageImpl theAnytypefeaturePackage = (AnytypefeaturePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AnytypefeaturePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AnytypefeaturePackageImpl());
		...
		theAnytypefeaturePackage.createPackageContents();

		// Initialize created meta-data
		theAnytypefeaturePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAnytypefeaturePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AnytypefeaturePackage.eNS_URI, theAnytypefeaturePackage);
		return theAnytypefeaturePackage;
	}
	 ...
	 * @generated
	 */
	public EReference getProperties_Anything() {
	 ...
	 * @generated
	 */
	public AnytypefeatureFactory getAnytypefeatureFactory() {
		return (AnytypefeatureFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(propertiesEClass, PROPERTIES__ANYTHING);
	...
	public void initializePackageContents() {
		...
		initEReference(getProperties_Anything(), ecorePackage.getEObject(), null, "anything", null, 1, 1, Properties.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
