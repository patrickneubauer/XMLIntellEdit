 ...
 * <ul>
 *   <li>{@link com.example.example.with.any.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.example.example.with.any.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.example.example.with.any.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.example.example.with.any.impl.DocumentRootImpl#getRootElement <em>Root Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends MinimalEObjectImpl.Container implements DocumentRoot {
	...
	public RootElementType getRootElement() {
		return (RootElementType)getMixed().get(AnyPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, true);
	}
	...
	public NotificationChain basicSetRootElement(RootElementType newRootElement, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(AnyPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, newRootElement, msgs);
	}
	...
	public void setRootElement(RootElementType newRootElement) {
		((FeatureMap.Internal)getMixed()).set(AnyPackage.Literals.DOCUMENT_ROOT__ROOT_ELEMENT, newRootElement);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case AnyPackage.DOCUMENT_ROOT__ROOT_ELEMENT:
