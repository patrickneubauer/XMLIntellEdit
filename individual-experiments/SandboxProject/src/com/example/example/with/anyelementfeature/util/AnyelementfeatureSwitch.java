 ...
 * @generated
 */
public class AnyelementfeatureSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AnyelementfeatureSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnyelementfeaturePackage.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnyelementfeaturePackage.ELEMENT1: {
				Element1 element1 = (Element1)theEObject;
				T result = caseElement1(element1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnyelementfeaturePackage.PROPERTIES: {
				Properties properties = (Properties)theEObject;
				T result = caseProperties(properties);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnyelementfeaturePackage.ROOT_ELEMENT_TYPE: {
