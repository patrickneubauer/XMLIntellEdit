...
import com.example.example.with.anyelementfeature.AnyelementfeatureFactory;
 ...
 * @generated
 */
public class AnyelementfeaturePackageImpl extends EPackageImpl implements AnyelementfeaturePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.example.example.with.anyelementfeature.AnyelementfeaturePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AnyelementfeaturePackageImpl() {
		super(eNS_URI, AnyelementfeatureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AnyelementfeaturePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AnyelementfeaturePackage init() {
		if (isInited) return (AnyelementfeaturePackage)EPackage.Registry.INSTANCE.getEPackage(AnyelementfeaturePackage.eNS_URI);

		// Obtain or create and register package
		AnyelementfeaturePackageImpl theAnyelementfeaturePackage = (AnyelementfeaturePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AnyelementfeaturePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AnyelementfeaturePackageImpl());
		...
		theAnyelementfeaturePackage.createPackageContents();

		// Initialize created meta-data
		theAnyelementfeaturePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAnyelementfeaturePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AnyelementfeaturePackage.eNS_URI, theAnyelementfeaturePackage);
		return theAnyelementfeaturePackage;
	}
	 ...
	 * @generated
	 */
	public AnyelementfeatureFactory getAnyelementfeatureFactory() {
		return (AnyelementfeatureFactory)getEFactoryInstance();
	}
