...
import com.example.example.with.anyattribute.AnyattributeFactory;
 ...
 * @generated
 */
public class AnyattributePackageImpl extends EPackageImpl implements AnyattributePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.example.example.with.anyattribute.AnyattributePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private AnyattributePackageImpl() {
		super(eNS_URI, AnyattributeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link AnyattributePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static AnyattributePackage init() {
		if (isInited) return (AnyattributePackage)EPackage.Registry.INSTANCE.getEPackage(AnyattributePackage.eNS_URI);

		// Obtain or create and register package
		AnyattributePackageImpl theAnyattributePackage = (AnyattributePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AnyattributePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AnyattributePackageImpl());
		...
		theAnyattributePackage.createPackageContents();

		// Initialize created meta-data
		theAnyattributePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAnyattributePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(AnyattributePackage.eNS_URI, theAnyattributePackage);
		return theAnyattributePackage;
	}
	 ...
	 * @generated
	 */
	public AnyattributeFactory getAnyattributeFactory() {
		return (AnyattributeFactory)getEFactoryInstance();
	}
