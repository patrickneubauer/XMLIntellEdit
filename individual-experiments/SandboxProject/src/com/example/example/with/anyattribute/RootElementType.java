 ...
 * <ul>
 *   <li>{@link com.example.example.with.anyattribute.RootElementType#getElement1 <em>Element1</em>}</li>
 *   <li>{@link com.example.example.with.anyattribute.RootElementType#getElement2 <em>Element2</em>}</li>
 *   <li>{@link com.example.example.with.anyattribute.RootElementType#getElement3 <em>Element3</em>}</li>
 *   <li>{@link com.example.example.with.anyattribute.RootElementType#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.example.example.with.anyattribute.AnyattributePackage#getRootElementType()
...
public interface RootElementType extends EObject {
	 ...
	 * @see com.example.example.with.anyattribute.AnyattributePackage#getRootElementType_Element1()
	...
	/**
	 * Sets the value of the '{@link com.example.example.with.anyattribute.RootElementType#getElement1 <em>Element1</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.with.anyattribute.AnyattributePackage#getRootElementType_Element2()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link com.example.example.with.anyattribute.RootElementType#getElement2 <em>Element2</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.with.anyattribute.AnyattributePackage#getRootElementType_Element3()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link com.example.example.with.anyattribute.RootElementType#getElement3 <em>Element3</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.example.example.with.anyattribute.AnyattributePackage#getRootElementType_Any()
